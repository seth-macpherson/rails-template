require 'simple_form_extensions/button_components'
...
SimpleForm.setup do |config|
  ...
  # whole input.
  config.wrappers :default, tag: :div, class: 'field', error_class: 'error' do |b|
  ...
  config.collection_label_methods = %i(to_label name title to_s)

  # Series of attempts to detect a default value method for collection.
  config.collection_value_methods = %i(id to_s)
  ...
  config.label_text = ->(label, _required, explicit_label) { explicit_label || label.to_s }
  ...
  # config.input_mappings = { /coordinates/ => :coordinate }
